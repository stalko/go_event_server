...
// registerHost register the new hosts for domains localhost:8080
// and 127.0.0.1:8080
func registerHost(handler fasthttp.RequestHandler) (server *fasthttp.Server, err error) {
...
// GenerateCert generate TLS certificate with private key(2048 bit)
